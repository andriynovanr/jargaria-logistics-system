  ...
  return (
    <aside className="flex flex-col w-64 min-h-screen bg-[#3D2314] border-r-[3px] border-black">
      ...
      <div className="flex items-center gap-3 px-5 pt-6 pb-8">
        <div className="border-[3px] border-black rounded-lg shadow-[3px_3px_0_0_#000] overflow-hidden">
          <Image
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-[#D4A843] text-[#3D2314] border-[2px] border-black shadow-[3px_3px_0_0_#000] rounded-none"
      ...
      <div className="px-4 py-4 border-t-[2px] border-[#5A3825]">
        <div className="flex items-center gap-3">
          <div className="size-10 rounded-none border-[2px] border-black bg-[#5A3825] flex items-center justify-center shrink-0 shadow-[2px_2px_0_0_#000]">
